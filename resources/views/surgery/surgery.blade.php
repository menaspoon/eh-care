          ...
          <?php $counter = 1; ?>
            ...
            <tr>
                ...
                <td class="actions"> 
                  ...
                  <a data-id="{{ $item->id }}" class="edit_surgery" data-bs-toggle="modal" data-bs-target="#EditModal"><i class="far fa-pencil-alt"></i></a>
                </td>
              </tr>
            @endforeach
        </tbody>
    ...
    <div class="modal-dialog">
      <form action="{{ url("import.excel.sheet.price") }}" method="POST" class="modal-content" enctype="multipart/form-data" >
        ...
        <div class="modal-body">
          ...
          <input type="hidden" required name="type" value="surgery" />
