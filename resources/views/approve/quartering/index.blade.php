...
<form  action="{{ url("store.approve.quartering.service") }}" method="POST" class="companies container form-contract">
  <br>
  <div class="row">
    @csrf
    <div class="col-md-6">
      <h3> مراجعـــة الايواء</h3>
      <br><br>
    </div> <!-- col-md-3 -->
    <div class="col-md-6">
      @if (Session::has("created"))
        <a style="float: left" class="text-center btn btn-primary" href="approve.quartering.service.details/{{ $approve->id }}">  طباعة المراجعــــة  </a>
      @endif
    </div> <!-- col-md-3 -->
      <div class="col-md-4">
