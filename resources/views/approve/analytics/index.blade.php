...
<form  action="{{ url("store.approve.analytics.service") }}" method="POST" class="companies container form-contract">
  <br>
  <div class="row">
    @csrf
    <div class="col-md-6">
      <h3> مراجعـــةالتحاليل </h3>
      <br><br>
    </div> <!-- col-md-3 -->
    <div class="col-md-6">
      @if (Session::has("created"))
        ...
        <table class="table" id="invoice_detales">
          ...
          <tbody>
            <tr class="invoice_parent_row">
              ...
              <td>
                <input type="number" name="subtotal[]" id="subtotal" class="subtotal form-control" >
              </td>
            </tr>
  ...
  ggggggggg
        ...
        <table>
          ...
          <tr>
            <td><input class="form-control" name="totle_price" id="all_title" name="all_title" placeholder="0.00"  > </td>
            <td><input class="form-control"  name="discount_percentage" value="%{{ $contract->ray_discount }}"></td>
            <td><input class="form-control"  name="discount_amount" id="discount_val"  value=""></td>
            <td><input class="form-control"  name="total_before_discount" id="before_discount" value="0.00"></td>
          </tr>
        </table>
...
$(document).on("change", ".get_service_price", function () {
    ...
    $(this).parent().next().next().next().children().val(price)
  ...
  <script>
    $(document).ready(function(){
      ...
      $(document).on("change keydown keyup text", ".price", function () {
