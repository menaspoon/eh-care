...
<form  action="{{ url("store.approve.physical.therapy.service") }}" method="POST" class="companies container form-contract">
  <br>
  <div class="row">
    @csrf
    <div class="col-md-6">
      <h3> مراجعة العلاج الطبيعي  </h3>
      <br><br> 
    </div> <!-- col-md-3 -->
    <div class="col-md-6">
      @if (Session::has("created"))
        <a style="float: left" class="text-center btn btn-primary" href="approve.physical.therapy.service.details/{{ $approve->id }}">  طباعة المراجعــــة  </a>
      @endif
    </div> <!-- col-md-3 -->
