    ...
    <div class="modal-dialog">
      <form action="{{ url("import.excel.sheet.price") }}" method="POST" class="modal-content" enctype="multipart/form-data" >
        ...
        <div class="modal-body">
          ...
          <input type="hidden" required name="type" value="ray" />
    ...
    <div class="modal-dialog">
      <form action="{{ route("store.ray") }}" method="POST" class="modal-content" enctype="multipart/form-data" >
        ...
        <div class="modal-body">
          ...
          <input type="hidden" required name="category" value="{{ request()->route("category") }}" />
          <input type="hidden" required name="service_provider" value="{{ request()->route("service_provider") }}" />                <input type="text" required name="name" id="form12" class="form-control" />
