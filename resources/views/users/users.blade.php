...
<table class="table">
  ...
  <tbody>
      ...
      <tr>
          ...
          <td>
            <a data-id="{{ $item->id }}" data-table="employees" class="users actions"><i class="far fa-trash-alt"></i></a>
...
<!-- الوقت الاضافي -->
<div class="modal fade" id="btn-time-overtime" tabindex="-1" role="dialog" aria-labelledby="btn-time-overtime" aria-hidden="true">
