...
class EmergencyApproveController extends Controller {
  ...
  function index() {
      ...
      $emergency  = Emergency::where("insurance_company", $acount->insurance_company)->get();
      ...
      return view("approve.emergency.index", compact("emergency", "contract",  "approve", "service_provider"));
  }
  ...
  function details($id) {
      ...
      $ApproveServiceDetails = ApproveServiceDetails::join("emergency", "emergency.id", "=", "approve_service_details.service")
      ->where("type", "emergency")->where("approve_id", $approve->id)->get();
      return view("approve.emergency.details", compact("company", "number", "approve", "contract",  "service_provider", "ApproveServiceDetails"));
  }
