...
class PhysicalTherapyApproveController extends Controller {
  ...
  function index() {
      ...
      $physical_therapy  = PhysicalTherapy::where("insurance_company", $acount->insurance_company)->get();
      ...
      return view("approve.physical_therapy.index", compact("physical_therapy", "contract",  "approve", "service_provider"));
  }
  ...
  function details($id) {
      ...
      $ApproveServiceDetails = ApproveServiceDetails::join("physical_therapy", "physical_therapy.id", "=", "approve_service_details.service")
      ->where("type", "physical_therapy")->where("approve_id", $approve->id)->get();

      return view("approve.physical_therapy.details", compact("company", "number", "approve", "contract",  "service_provider", "ApproveServiceDetails"));
  }
