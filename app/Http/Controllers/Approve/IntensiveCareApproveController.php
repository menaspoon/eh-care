...
class IntensiveCareApproveController extends Controller {
  ...
  function index() {
      ...
      $surgery  = IntensiveCare::where("insurance_company", $acount->insurance_company)->get();
      ...
      return view("approve.intensive_care.index", compact("surgery", "contract",  "approve", "service_provider"));
  }
  ...
  function details($id) {
      ...
      $ApproveServiceDetails = ApproveServiceDetails::join("intensive_care", "intensive_care.id", "=", "approve_service_details.service")
      ->where("type", "intensive_care")->where("approve_id", $approve->id)->get();
      return view("approve.intensive_care.details", compact("company", "number", "approve", "contract",  "service_provider", "ApproveServiceDetails"));
  }
