...
class QuarteringApproveController extends Controller {
  ...
  function index() {
      ...
      $quartering  = Quartering::where("insurance_company", $acount->insurance_company)->get();
      ...
      return view("approve.quartering.index", compact("quartering", "contract",  "approve", "service_provider"));
  }
  ...
  function details($id) {
      ...
      $ApproveServiceDetails = ApproveServiceDetails::join("quartering", "quartering.id", "=", "approve_service_details.service")
      ->where("type", "quartering")->where("approve_id", $approve->id)->get();
      return view("approve.quartering.details", compact("company", "number", "approve", "contract",  "service_provider", "ApproveServiceDetails"));
  }
