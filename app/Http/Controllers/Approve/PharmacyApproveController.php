...
class PharmacyApproveController extends Controller {
  ...
  function index() {
      ...
      $pharmacy  = Pharmacy::where("insurance_company", $acount->insurance_company)->get();
      ...
      return view("approve.pharmacy.index", compact("pharmacy", "contract",  "approve", "service_provider"));
  }
  ...
  function details($id) {
      ...
      $ApproveServiceDetails = ApproveServiceDetails::join("pharmacy", "pharmacy.id", "=", "approve_service_details.service")
      ->where("type", "pharmacy")->where("approve_id", $approve->id)->get();
      return view("approve.pharmacy.details", compact("company", "number", "approve", "contract",  "service_provider", "ApproveServiceDetails"));
  }
