...
class SurgeryDepartmentController extends Controller {
  ...
  function index() {
      ...
      $categories  = SurgeryDepartment::where("hospital", $acount->hospital)->get();
  ...
  function edit(Request $request) {
    if($request->ajax()) {
      $id = $request->get('id');
      $data = SurgeryDepartment::where('id', $id)->first();
  ...
  function  update(Request $request) {
    ...
    SurgeryDepartment::where("id", $request->id)->update([
